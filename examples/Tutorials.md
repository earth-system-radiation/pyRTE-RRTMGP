...
Here are two worked examples showing the calculation of fluxes from atmospheric state with the 
RRTMGP gas and cloud optics. The first demonstrates the calculation of clear-sky fluxes using conditions  
provided by the Radiative Forcing Model Intercomparison Project as described in 
